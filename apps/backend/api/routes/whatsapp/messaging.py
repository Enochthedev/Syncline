...
async def poll_login_status(
    ...
    return {
        ...
        "message": "Login completed" if status_result["logged_in"] else "Waiting for login"
    }
...
async def start_background_sync(
    ...
    background_tasks.add_task(background_sync_service.start_background_sync, sync_interval)
...
async def setup_webhook(
    ...
    result = await webhook_service.setup_webhook_subscription(connection_id, request.webhook_url)
