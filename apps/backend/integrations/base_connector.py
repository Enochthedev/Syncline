...
class ConnectorHealth(BaseModel):
    ...
    connector_status: ConnectorStatus = Field(description="Connector operational status")
    ...
    metadata: Dict[str, Any] = Field(
        ...
        description="Additional platform-specific health data"
    )
...
class CircuitBreakerState(BaseModel):
    ...
    half_open_at: Optional[datetime] = Field(
        default=None,
        description="When circuit enters half-open state"
    )
