...
def upgrade() -> None:
    ...
    sa.Column('platform_identities', postgresql.JSONB(astext_type=sa.Text()), nullable=True),
    ...
    op.create_index(op.f('ix_contacts_canonical_name'), 'contacts', ['canonical_name'], unique=False)
    ...
    sa.Column('participant_metadata', postgresql.JSONB(astext_type=sa.Text()), nullable=True),
    sa.Column('id', sa.UUID(), nullable=False),
    sa.Column('created_at', sa.DateTime(), nullable=False),
    sa.Column('updated_at', sa.DateTime(), nullable=False),
    ...
    op.create_index(op.f('ix_participants_contact_id'), 'participants', ['contact_id'], unique=False)
    ...
    op.create_index(op.f('ix_participants_platform'), 'participants', ['platform'], unique=False)
    op.create_index(op.f('ix_participants_platform_user_id'), 'participants', ['platform_user_id'], unique=False)
    op.create_table('platform_connections',
    sa.Column('user_id', sa.UUID(), nullable=False),
    sa.Column('platform', sa.Enum('GMAIL', 'SLACK', 'DISCORD', 'WHATSAPP', 'TWITTER', 'TELEGRAM', name='platform_type'), nullable=False),
    sa.Column('credentials', postgresql.JSONB(astext_type=sa.Text()), nullable=False),
    sa.Column('status', sa.Enum('ACTIVE', 'INACTIVE', 'EXPIRED', 'FAILED', 'REVOKED', name='connection_status'), nullable=False),
    ...
    op.create_index(op.f('ix_platform_connections_created_at'), 'platform_connections', ['created_at'], unique=False)
    ...
    op.create_index(op.f('ix_threads_first_message_at'), 'threads', ['first_message_at'], unique=False)
    ...
    op.create_index(op.f('ix_threads_platform_thread_id'), 'threads', ['platform_thread_id'], unique=False)
    op.create_table('collection_jobs',
    sa.Column('connection_id', sa.UUID(), nullable=False),
    sa.Column('job_type', sa.Enum('HISTORICAL', 'REALTIME', 'INCREMENTAL', name='job_type'), nullable=False),
    sa.Column('status', sa.Enum('PENDING', 'RUNNING', 'PAUSED', 'COMPLETED', 'FAILED', 'CANCELLED', name='job_status'), nullable=False),
    ...
    op.create_index(op.f('ix_collection_jobs_created_at'), 'collection_jobs', ['created_at'], unique=False)
    ...
    sa.ForeignKeyConstraint(['connection_id'], ['platform_connections.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('connection_id', 'platform_message_id', name='uq_connection_platform_message')
    )
    op.create_index(op.f('ix_raw_messages_connection_id'), 'raw_messages', ['connection_id'], unique=False)
    ...
    op.create_index(op.f('ix_raw_messages_platform'), 'raw_messages', ['platform'], unique=False)
    op.create_index(op.f('ix_raw_messages_platform_message_id'), 'raw_messages', ['platform_message_id'], unique=False)
    op.create_index(op.f('ix_raw_messages_processed'), 'raw_messages', ['processed'], unique=False)
    ...
    sa.ForeignKeyConstraint(['sender_id'], ['participants.id'], ondelete='SET NULL'),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('connection_id', 'platform_message_id', name='uq_connection_normalized_message')
    )
    ...
    op.create_index(op.f('ix_messages_raw_message_id'), 'messages', ['raw_message_id'], unique=True)
    ...
    op.create_index(op.f('ix_embeddings_message_id'), 'embeddings', ['message_id'], unique=True)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_raw_messages_platform_message_id'), table_name='raw_messages')
    ...
    op.drop_index(op.f('ix_platform_connections_created_at'), table_name='platform_connections')
