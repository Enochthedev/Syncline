                    ...
                    try:
                        ...
                        if messages:
                            ...
                            for msg in messages[:2]:
                                ...
                                content = msg.get("content", {}).get("body", "No content")
                ...
                if potential_matches:
                    ...
                    for match in potential_matches:
                        ...
                        try:
                            ...
                            event_id = await connector.send_message(room['room_id'], test_msg)
                    ...
                    print("\n💡 Suggestions:")
                    print("1. Start a conversation with +2349073069006 from your WhatsApp")
