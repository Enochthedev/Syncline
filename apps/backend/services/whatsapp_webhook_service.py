...
class WhatsAppWebhookService:
    ...
    async def _process_matrix_event(
        ...
        try:
            ...
            if synced_count > 0:
                ...
                self.logger.info(f"Processed real-time message from {sender} in room {room_id}")
                return True
    ...
    async def _find_connection_for_room(
        ...
        try:
            ...
            for connection in connections:
                if connection.credentials and connection.credentials.get("matrix_access_token"):
                    return connection
    ...
    async def setup_webhook_subscription(
        ...
        try:
            ...
            self.logger.info(f"Webhook subscription setup for connection {connection_id}")
    ...
    async def remove_webhook_subscription(
        ...
        try:
            ...
            self.logger.info(f"Webhook subscription removed for connection {connection_id}")
