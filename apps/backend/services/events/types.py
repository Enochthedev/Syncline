...
class ConnectionEvent(Event):
    ...
    event_type: EventType = Field(
        default=EventType.CONNECTION_ESTABLISHED, description="Connection event type"
    )
...
class MessageEvent(Event):
    ...
    event_type: EventType = Field(
        default=EventType.MESSAGE_COLLECTED, description="Message event type"
    )
...
class ContactEvent(Event):
    ...
    event_type: EventType = Field(
        default=EventType.CONTACT_MATCHED, description="Contact event type"
    )
...
class ThreadEvent(Event):
    ...
    event_type: EventType = Field(
        default=EventType.THREAD_CREATED, description="Thread event type"
    )
...
class AIEvent(Event):
    ...
    event_type: EventType = Field(
        default=EventType.EMBEDDING_GENERATED, description="AI event type"
    )
