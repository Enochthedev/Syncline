...
class InsightGenerator:
    ...
    async def generate_contact_insights(
        ...
        try:
            ...
            topic_insights = await self._identify_trending_topics(
                contact_id, db, days
            )
            ...
            logger.info(
                f"Generated {len(insights)} insights for contact {contact_id}"
            )
            return insights
    ...
    async def _identify_trending_topics(
        ...
        try:
            ...
            entity_counts = Counter(
                entity.entity_text.lower() for entity in entities
            )
...
Confidence: [confidence]"""
            ...
            # Validate sentiment
            if sentiment_data.get("overall") not in ["positive", "neutral", "negative", "mixed"]:
