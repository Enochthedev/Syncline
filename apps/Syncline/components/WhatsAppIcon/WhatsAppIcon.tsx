...
export const WhatsAppIcon = ({ size = 24, color }: WhatsAppIconProps) => {
    // If color is specified, use solid color (for white icons on colored backgrounds)
    if (color) {
        return (
            <Svg width={size} height={size} viewBox="0 0 175.216 175.552">
                ...
                />
                <Path
                    fill={color === 'white' || color === '#fff' || color === '#ffffff' ? '#25D366' : '#fff'}
                    fillRule="evenodd"
